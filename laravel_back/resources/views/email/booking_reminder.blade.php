            ...
            <tr>
                <td class="content-cell_mailru_css_attribute_postfix" style="font-family: Avenir, Helvetica, sans-serif;box-sizing: border-box;padding: 35px;">
                    <p style="font-family: Avenir, Helvetica, sans-serif;box-sizing: border-box;color: #74787E;font-size: 16px;line-height: 1.5em;margin-top: 0;text-align: center;">
                        ...
                        We remind you have been reserved a seat for {{date("F d - ", strtotime($data->start)).date("d", strtotime($data->end))}} on {{$data->event->title}} live course. The end of the booking period soon, after this the reservation will be canceled.
                    </p>
                    ...
                    <div style="display: block; margin: 0 auto; width: 100%; text-align: center">
                        ...
                        <span style="display:inline-block;padding: 15px 20px 15px 30px; font-family: Roboto;font-style: normal;font-weight: bold;font-size: 20px;line-height: 30px;color: white;width: 70px;height: 30px;background: #000000; color:white; margin: 0 0 0 -5px;"
                        >{{$data->event->actual_price}} {{$settings->currency_sign}}</span>
                    </div>
                </td>
            </tr>
            </tbody>
