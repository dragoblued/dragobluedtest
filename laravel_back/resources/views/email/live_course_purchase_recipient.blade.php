                ...
                <tr>
                    <td class="content-cell_mailru_css_attribute_postfix" style="box-sizing: border-box;padding: 35px;">
                        ...
                        <p style="width: 455px;font-family: Roboto;font-style: normal;font-weight: normal; font-size: 20px;line-height: 28px;color: #5A5E62;margin: 30px auto;text-align: center;">
                            ...
                            A seat has been reserved and paid for you by {{$purchaseUser['name'] ?: $purchaseUser['login']}}(<a href="mailto:{{$purchaseUser['email']}}" style="font-family: Roboto, Helvetica, sans-serif;box-sizing: border-box;color: #69A7F7;font-size: 18px;font-weight:bold;text-decoration: underline;text-shadow: 0 1px 0 white;" rel="noopener noreferrer">{{$purchaseUser['email']}}</a>) for {{date("F d - ", strtotime($data->start)).date("d", strtotime($data->end))}} on {{$data->event->title}} live course.<br> You can find more information about the course in the following link
                        </p>
