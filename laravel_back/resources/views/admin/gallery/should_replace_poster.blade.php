<div class="form-group">
   <div class="custom-control custom-checkbox mt-2 mb-3 d-inline-block">
...
<script>
   const toggleReadonly = (value) => {
      ...
      const posterElement = document.querySelector('[name="poster_url"]');
      posterElement.toggleAttribute('disabled');
      if (value === true) {
         posterElement.parentElement.classList.add('disabled');
      } else {
         posterElement.parentElement.classList.remove('disabled');
      }
   }
</script>
